...
if __name__ == "__main__":
    model = YOLO(
        model='/home/yuqingchi/Code/Yolo-ONNX-TensorRT/yolov13/ultralytics/cfg/models/v13/yolov13.yaml'
    )
    model.load('/home/yuqingchi/Code/Yolo-ONNX-TensorRT/yolov13n.pt')
    # 一般情况下不加载预训练权重。
    model.train(
